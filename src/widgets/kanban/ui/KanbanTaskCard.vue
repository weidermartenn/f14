<template>
  <div class="w-72 h-32 p-2 flex flex-col justify-between bg-bg-dark rounded-md border-2 border-gray-700">
    ...
    <span class="inline-block text-md truncate max-w-[100%]">Задача такая-то где-то созданная каким-то человеком</span>
    <div class="mt-4 flex justify-between">
      <div class="flex flex-col">
        <span class="text-xs text-gray-400">Приоритет: 1</span>
        <span class="text-xs text-gray-400">Статус: 1</span>
        <span class="text-xs text-gray-400">Дата создания: 1</span>
      </div>
      <div class="">
          sdfkjsd
      </div>
